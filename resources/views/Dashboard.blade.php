...
<body>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="widget col-lg-3 col-md-3 col-sm-12">
        ...
        <ul class="flickr">
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_01.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_02.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_03.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_04.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_05.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_06.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_07.jpg')}}"></a></li>
          <li><a href="#"><img alt="" src="{{asset('assets-guest/img/flickr_08.jpg')}}"></a></li>
        </ul>
      </div>
      <!-- end widget -->
    </div>
  ...
  <script src="{{asset('assets-guest/lib/php-mail-form/validate.js')}}"></script>
  <script src="{{asset('assets-guest/lib/prettyphoto/js/prettyphoto.js')}}"></script>
  <script src="{{asset('assets-guest/lib/isotope/isotope.min.js')}}"></script>
  <script src="{{asset('assets-guest/lib/hover/hoverdir.js')}}"></script>
  <script src="{{asset('assets-guest/lib/hover/hoverex.min.js')}}"></script>
  <script src="{{asset('assets-guest/lib/unveil-effects/unveil-effects.js')}}"></script>
  ...
  <script src="{{asset('assets-guest/lib/animate-enhanced/animate-enhanced.min.js')}}"></script>
  <script src="{{asset('assets-guest/lib/jigowatt/jigowatt.js')}}"></script>
